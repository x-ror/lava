...
(function (require, module, exports) {
	...
	Object.defineProperty(AbortSignal.prototype, "aborted", {
		get: function () { return this._aborted; }, configurable: true,
	});
	Object.defineProperty(AbortSignal.prototype, "reason", {
		get: function () { return this._reason; }, configurable: true,
	});
	...
	AbortSignal.timeout = function (delay) {
		var signal = newSignal();
		var timer = setTimeout(function () { runAbort(signal, timeoutError()); }, delay);
	...
	AbortSignal.any = function (signals) {
		...
		for (var i = 0; i < list.length; i++) {
			if (list[i]._aborted) { runAbort(combined, list[i]._reason); return combined; }
		}
		list.forEach(function (source) {
			source.addEventListener(ABORT, function () { runAbort(combined, source._reason); });
		});
		return combined;
	};
