...
- [pr-gate](../../../.claude/skills/pr-gate/SKILL.md) + [gates.md](../../../.claude/skills/pr-gate/reference/gates.md) + [scoring.md](../../../.claude/skills/pr-gate/reference/scoring.md)
- [odin-feature](../../../.claude/skills/odin-feature/SKILL.md) — use `--design-only` inside the cycle
