...
- A dedicated `*_host` wrapper added for a _cold_ native with no measurement — that
...
diff _lost_ speed to gain parity, that is usually correct — note the cost, do not
block.
