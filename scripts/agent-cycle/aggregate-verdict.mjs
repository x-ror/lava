#!/usr/bin/env node
// Agent-cycle F5 — severity-only aggregator + SHIP / SHIP-AFTER / BLOCK.
// Encodes pr-gate scoring.md rules the autonomous cycle can apply without self-waive.
//
// Usage:
//   node scripts/agent-cycle/aggregate-verdict.mjs findings1.json [findings2.json ...]
//   echo '{...}' | node scripts/agent-cycle/aggregate-verdict.mjs --stdin
//
// Env:
