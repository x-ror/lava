...
test('self-protect: blocks Edit of gate-integrity.mjs', () => {
  assert.equal(checkWritePath('scripts/agent-cycle/gate-integrity.mjs').blocked, true);
});
...
test('PROTECTED_WRITE_PATHS includes self-protect entries', () => {
  ...
  assert.ok(PROTECTED_WRITE_PATHS.includes('scripts/agent-cycle/gate-integrity.mjs'));
